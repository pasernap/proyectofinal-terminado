...
public class TableroU extends JPanel implements ActionListener, KeyListener{
    ...
    public TableroU(){
      ...
      this.personajePrincipal = new Carro(216-c,60+c);
      ...
      //---------------------------------------lineabajo-------------
      this.circulo.add(new Circulo(216,c+60));
      this.circulo.add(new Circulo(216,c+128));
      this.circulo.add(new Circulo(216,c+196));
      this.circulo.add(new Circulo(216,c+264));
      this.circulo.add(new Circulo(216,c+332));
      this.circulo.add(new Circulo(216,c+400));
      
      //---------------------------------------lineabajo2-------------
      this.circulo.add(new Circulo(692,c+60));
      this.circulo.add(new Circulo(692,c+128));
      this.circulo.add(new Circulo(692,c+196));
      this.circulo.add(new Circulo(692,c+264));
      this.circulo.add(new Circulo(692,c+332));
      this.circulo.add(new Circulo(692,c+400));
      this.circulo.add(new Circulo(692,c+468));
      
       //---------------------------------------lineabajo-------------
      this.circulo.add(new Circulo(284,c+468));
      this.circulo.add(new Circulo(352,c+536));
      this.circulo.add(new Circulo(420,c+604));
      this.circulo.add(new Circulo(488,c+604));
      //---------------------------------------lineabajo2-------------
      this.circulo.add(new Circulo(624,c+468));
      this.circulo.add(new Circulo(556,c+536));
      this.circulo.add(new Circulo(488,c+604));
      //-----------------------------------------lateral-----------
      this.circulo.add(new Circulo(760,c+536));
      this.circulo.add(new Circulo(828,c+604));
      //-----------------------------------------dulces----------;
      this.dulce.add(new Dulce(828,c+542));
      this.dulce.add(new Dulce(760,c+196));
      this.dulce.add(new Dulce(284,c+332));
      //-----------------------------------------trans-----------
      this.trans.add(new Trans(624,c+400));
       ...
       public void validarTrans(){
        ...
        for(Trans t : trans){
           ...
           if(recPersonaje.intersects(RecCir)){
               ...
               this.personajePrincipal.setY(60);
           }
           this.trans=copiat;   
