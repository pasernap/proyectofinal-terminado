...
public class TableroO extends JPanel implements ActionListener, KeyListener{
    ...
    public TableroO(){
      ...
      ///-------------------------------------sube----------------
      this.circulo.add(new Circulo(284,196+c));
      this.circulo.add(new Circulo(352,128+c));
      this.circulo.add(new Circulo(488,60+c));
      //---------------------------------------baja-------------
      this.circulo.add(new Circulo(556,60+c));
      this.circulo.add(new Circulo(624,60+c));
      this.circulo.add(new Circulo(692,128+c));
      this.circulo.add(new Circulo(760,196+c));
      //---------------------------------------lineabajo-------------
      this.circulo.add(new Circulo(216,400+c));
      this.circulo.add(new Circulo(284,468+c));
      this.circulo.add(new Circulo(352,536+c));
      this.circulo.add(new Circulo(420,604+c));
      this.circulo.add(new Circulo(488,604+c));
      //---------------------------------------lineabajo2-------------
      this.circulo.add(new Circulo(828,400+c));
      this.circulo.add(new Circulo(760,468+c));
      this.circulo.add(new Circulo(692,536+c));
      this.circulo.add(new Circulo(624,604+c));
      this.circulo.add(new Circulo(556,604+c));
      //-----------------------------------------dulces----------
      this.dulce.add(new Dulce(488,-8+c));
      this.dulce.add(new Dulce(216,332+c));
      this.dulce.add(new Dulce(692,468+c));
      //-----------------------------------------trans-----------
      this.trans.add(new Trans(828,264+c));
...
public void validarTrans(){
        ...
        for(Trans t : trans){
           ...
           if(recPersonaje.intersects(RecCir)){
               ...
               this.personajePrincipal.setY(128+c);
           }
           this.trans=copiat;   
